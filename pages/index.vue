    ...
    <NuxtLayout>
        ...
        <div class="mt-16 mx-4 md:mx-auto md:w-10/12 lg:w-8/12 max-w-4xl">
            <NuxtLink to="/competition"
                class="group flex flex-col sm:flex-row items-center gap-4 p-5 bg-white border-2 border-brand-200 rounded-2xl shadow-sm hover:shadow-md hover:border-brand-400 transition-all">
                <div class="flex items-center justify-center bg-brand-50 rounded-xl p-3 shrink-0">
                    <span class="text-3xl">🏆</span>
                </div>
                <div class="text-center sm:text-left flex-1">
                    <span class="inline-block text-xs font-semibold text-brand-600 bg-brand-50 border border-brand-200 px-2 py-0.5 rounded-full mb-1">New</span>
                    <h3 class="font-serif font-semibold text-gray-700 text-lg leading-tight">CodeQuest Challenge 2026</h3>
                    <p class="text-gray-500 text-sm mt-0.5">Our very first coding competition is here! Build an app or website and compete for a certificate of achievement.</p>
                </div>
                <div class="shrink-0">
                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm mb-2">Learn the basics of Python, a popular programming
                                language used by
                                companies like Google and Facebook.</p>
                        </div>
                        <div class="mt-2">
                            <NuxtLink class="text-gray-600 text-sm underline font-medium" to="/courses/python-1a">
                                <h6>Learn more</h6>
                            </NuxtLink>
                        </div>
                    </div>
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm mb-2">Explore HTML & CSS by creating your own websites.</p>
                        </div>
                        <div class="mt-2">

                            <NuxtLink class="text-gray-600 text-sm underline font-medium" to="/courses/web-design-1ab">
                                <h6>Learn more</h6>
                            </NuxtLink>
                        </div>
                    </div>
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-sm mb-2">A gentle introduction to programming through Scratch.
                            </p>
                        </div>
                        <div class="mt-2">

                            <NuxtLink class="text-gray-600 text-sm underline font-medium"
