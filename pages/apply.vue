          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="flex flex-col border border-gray-200 rounded-lg p-6 gap-y-2">
              ...
              <div class="p-2">
                ...
                <div class="mt-6">
                  <LinkButton to="https://forms.gle/XjVUnNWk6gghyp4U6">Apply</LinkButton>
                </div>
              </div>
            ...
            <div class="flex flex-col border border-gray-200 rounded-lg p-6 gap-y-2">
              ...
              <div class="p-2">
                ...
                <div class="mt-6">
                  <LinkButton to="https://forms.gle/xKYcqgK7HrGykoTq6">Apply</LinkButton>
                </div>
              </div>
            ...
            <div class="flex flex-col border border-gray-200 rounded-lg p-6 gap-y-2">
              ...
              <div class="p-2">
                ...
                <div class="mt-6">
                  <LinkButton to="https://forms.gle/ZyyS26jSqfPkRyCQA">Apply</LinkButton>
                </div>
              </div>
