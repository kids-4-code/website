<!--the LinkButton except w/o a link and more rounded-->

<template>
  <div class="font-sans font-medium text-sm transition-colors px-3 py-1 rounded-full"
    :class="[...colors, ...extraStyles]">
    <slot></slot>
  </div>
</template>
